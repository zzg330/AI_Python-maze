...
print("Solution:")
m.print()
png_file_name = "maze.png"
if sys.argv[1] == "maze1.txt":
    png_file_name = "maze1.png"
elif sys.argv[1] == "maze2.txt":
    png_file_name = "maze2.png"
else:
    png_file_name = "maze3.png"
m.output_image(png_file_name, show_explored=True)
